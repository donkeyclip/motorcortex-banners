...
var BannerA = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(BannerA, [{
    ...
    value: function buildTree() {
      var box = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      var leftImageTop = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      var leftImageLeft = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      var rightImageTop = new motorcortex.CSSEffect({
        animatedAttrs: {
          backgroundPositionY: "".concat(this.attrs.height - this.attrs.imgHeight / 2, "px"),
          top: "-50%"
        },
      ...
      var rightImageLeft = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      var rightImageLeftWrapper = new motorcortex.CSSEffect({
        animatedAttrs: {
          width: "".concat(this.attrs.width / 2, "px")
        },
        initialValues: {
      ...
      var dotedHalfOneOn = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
      ...
      var dotedHalfOneOff = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 0
        },
        initialValues: {
      ...
      var dotedOneOn = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
      ...
      var dotedOneOff = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 0
        },
        initialValues: {
      ...
      var bg2In = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var bg2InBg = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      for (var i = 0; i < this.n; i++) {
        var textAnimationSize = new motorcortex.CSSEffect({
          animatedAttrs: {
      ...
      var bg2OutBg = new motorcortex.CSSEffect({
        animatedAttrs: {
          width: "0px"
        }
      }, {
      ...
      var bgInBg = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
      ...
      var linesInOut = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "-100%",
      ...
      var circlesWrapper = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
      ...
      var circlesWrapperOp = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 0
        },
        initialValues: {
      ...
      for (var _i = 1; _i <= 3; _i++) {
        ...
        var translateX = new motorcortex.CSSEffect({
          animatedAttrs: {
            transform: {
              rotate: ran,
      ...
      var centerTextWrapper = new motorcortex.CSSEffect({
        animatedAttrs: {
          transform: {
            scale: 1
          }
      ...
      var centerTextAfter = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "49%",
          top: "51%"
        },
      ...
      var centerTextBefore = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "51%",
          top: "49%"
        },
      ...
      var slicedImgWrapper = new motorcortex.CSSEffect({
        animatedAttrs: {
          top: "0%"
        },
        initialValues: {
      ...
      var slicedImg = new motorcortex.CSSEffect({
        animatedAttrs: {
          top: "0%"
        },
        initialValues: {
      ...
      var slicedImgWrappeClipPath = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      var slicedImgTranformUp = new motorcortex.CSSEffect({
        animatedAttrs: {
          transform: {
            scale: 1.5
          }
      ...
      var slicedImgTranformDown = new motorcortex.CSSEffect({
        animatedAttrs: {
          transform: {
            scale: 1
          }
      ...
      var slicedImgWrapperOpacity = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 0
        },
        initialValues: {
      ...
      var strokeTextWrapper = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
      ...
      var strokeTextCenter = new motorcortex.CSSEffect({
        animatedAttrs: {
      ...
      for (var _i2 = 0; _i2 < this.strokeTextLength; _i2++) {
        var strokeTextOutline = new motorcortex.CSSEffect({
          animatedAttrs: {
      ...
      var bgDistortionOp = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 0
        },
        initialValues: {
      ...
      var bgScaleUp = new motorcortex.CSSEffect({
        animatedAttrs: {
          transform: {
            scale: 1.5
          }
      ...
      var bgScaleDown = new motorcortex.CSSEffect({
        animatedAttrs: {
          transform: {
            scale: 1
          }
      ...
      var rngBoxDownIn = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "30%"
        },
        initialValues: {
      ...
      var yellowUnderLineLeftIn = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "30%"
        },
        initialValues: {
      ...
      var yellowUnderLineWidth = new motorcortex.CSSEffect({
        animatedAttrs: {
          width: "0px"
        }
      }, {
      ...
      var yellowTransitionWidth = new motorcortex.CSSEffect({
        animatedAttrs: {
          width: "0px"
        }
      }, {
      ...
      var yellowTransitionLeft = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "-100%"
        }
      }, {
      ...
      var circlesWrapper2 = new motorcortex.CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
      ...
      var circlesWrapper2Position = new motorcortex.CSSEffect({
        animatedAttrs: {
          top: "-33%",
          left: "-33%"
        }
      ...
      for (var _i3 = 1; _i3 <= 3; _i3++) {
        ...
        var _translateX = new motorcortex.CSSEffect({
          animatedAttrs: {
            transform: {
              rotate: _ran,
              translateX: "".concat(this.attrs.width / 2 * Math.random(), "px"),
      ...
      var blackBoxRotate = new motorcortex.CSSEffect({
        animatedAttrs: {
          transform: {
            rotate: "-90deg"
          }
      ...
      var blackBoxLeftTop = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
      ...
      var blackBoxRightTop = new motorcortex.CSSEffect({
        animatedAttrs: {
          left: "0%"
        },
        initialValues: {
